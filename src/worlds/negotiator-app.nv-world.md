...
- `signals_only_no_interpretation` — Negotiator MUST always surface behavioral signals — observable patterns in speech, timing, and consistency. It MUST NEVER interpret emotional or symbolic meaning. "They paused for 4 seconds on a simple question" is a signal. "They seem anxious about the deal" is interpretation. "The timeline changed between tellings" is a signal. "They feel guilty about what happened" is interpretation. Negotiator reads the instrument panel — it does not write the story. Signals are data. Interpretation is opinion. This app outputs data. (structural, immutable)
